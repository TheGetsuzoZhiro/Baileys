...
const offerCall = async (toJid, counts = "0", ott = "0", screenWidth = "1920", screenHeight = "1080", deviceOtt = "0", isVideo = false) => {
...
offerContent.push({
tag: 'video',
attrs: { enc: 'vp8', dec: 'vp8', orientation: ott, 'screen_width': screenWidth, 'screen_height': '1080', 'device_orientation': deviceOtt },
content: undefined
})
}
